...
describe('BrightSky Weather Data Integration Tests', function() {
    ...
    it('should complete comprehensive weather data retrieval for German coordinates', async function() {
        ...
        if (currentTemp !== null) expect(currentTemp).to.be.a('number');
        if (firstHourlyTemp !== null) expect(firstHourlyTemp).to.be.a('number');
        if (firstDailyTemp !== null) expect(firstDailyTemp).to.be.a('number');
