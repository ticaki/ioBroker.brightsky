...
// Import or define Brightsky before using it as AdapterClassDefinition
import type { Brightsky } from './Brightsky'; // Adjust the import path as needed
export type AdapterClassDefinition = Brightsky;
